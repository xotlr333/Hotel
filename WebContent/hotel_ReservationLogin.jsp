...
<form name="reservation" action="reservationConfirm.do" >
 <div class="container" align="center">
    ...
    <div>
     <table>
      <tr>
       <td colspan="2"><h4>글쓰기 로그인 확인</h4></td>
      <tr>
       <td width="100px"><div style="margin:11px">체크아웃</div></td> 
       <td><input type="text" id="wcheckout" name="wcheckout" placeholder="2021/3/04형태로 작성"></td>
      </tr> 
      <tr>
      ...
      <tr>
       ...
       <td><input type="text" id="wphone" name="wphone"></td>
      </tr>   
     </table>
    </div>   
