...
<form name="review" action="ResDelete.do" >
 <div class="container" align="center">
     <table width=860px>
       <tr align="right">
        <td colspan="4">
         <a href="HotelResList.do"><input type="button" value="목록" style="background-color:white ; color : #3c3c8c; width:100px; height:38px;"></a>
     ...
     <div>
      <table>
       <tr>
        <td colspan="2"><h4>예약취소 로그인 확인</h4></td>
       </tr>
       <tr>
