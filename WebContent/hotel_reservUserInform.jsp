				...
				<div class="information">
					<div class="revInfo">
						...
						<table>
							...
							<tr>	
								<td>체크아웃</td>
								<td>:<input type="hidden"  name="checkout" value="<%=checkout %>"> <%=checkout %></td>
							<tr>
								<td>객실</td>
								<td>:<input type="hidden"  name="roomSel" value="<%=roomsel %>"> <%=roomsel %></td>
							</tr>
							<tr>
								<td>전화번호</td>
								<td>: <input type="text" placeholder="-없이 입력해주세요" name="tel" value="" ></td>
							</tr>
							<tr>
								<td>이름</td>
							...
							<tr>
								<td>예약 비밀번호</td>
								<td>: <input type="password" maxlength = '4' placeholder="4자리 비밀번호" name="pwd" value="" ></td>							
							</tr>
							<tr>
								<td><input type="button" class="button btn_set btn_left" id="btn_back" value="뒤로가기"></td>
								<td><input type="button" class="button btn_set btn_left" id="btn_next" value="최종 예약내용 확인"></td>
							</tr>
						</table>
						</form>
						<br>					
