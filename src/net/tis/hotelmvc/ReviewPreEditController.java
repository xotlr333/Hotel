...
@WebServlet("/reviewPreEdit.do")
public class ReviewPreEditController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public ReviewPreEditController() {
        super();
    ...
    protected void doUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(id.equals(idc)&&pwd.equals(pwdc)) 
		{
		  ...
		  RequestDispatcher dis = request.getRequestDispatcher("hotel_ReviewEdit.jsp");
